...
from src.tiles.tile import Tile, Suit, Wind, Dragon
...
class TestMahjongEngine:
    ...
    def test_hand_completion_check(self):
        ...
        tiles = [
            ...
            Tile(Suit.SOUZU, 3), Tile(Suit.SOUZU, 3), Tile(Suit.SOUZU, 3),
            Tile(Suit.SOUZU, 4), Tile(Suit.SOUZU, 4),
            Tile(Suit.WIND, wind=Wind.EAST), Tile(Suit.WIND, wind=Wind.EAST), 
    ...
    def test_meld_creation(self):
        ...
        # Test sequence
        sequence_tiles = [
            Tile(Suit.SOUZU, 1), Tile(Suit.SOUZU, 2), Tile(Suit.SOUZU, 3)
        ]
        ...
        # Test triplet
        triplet_tiles = [
            Tile(Suit.PINZU, 5), Tile(Suit.PINZU, 5), Tile(Suit.PINZU, 5)
        ]
    ...
    def test_scoring_calculation(self):
        ...
        score, payments = Scoring.calculate_score(yaku_list, is_dealer=False, is_tsumo=True)
