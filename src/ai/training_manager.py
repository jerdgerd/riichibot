...
class TrainingManager:
    ...
    def play_training_game(self, game: MahjongEngine, players: List[NeuralPlayer]) -> Dict[str, Any]:
    ...
    def calculate_action_reward(self, action: str, result: Dict[str, Any], 
                            player_hand: Dict[str, Any]) -> float:
    ...
    def update_training_stats(self, players: List[NeuralPlayer], result: Dict[str, Any]):
    ...
    def plot_training_progress(self):
        ...
        ax4.boxplot([recent_wins[:, i] for i in range(4)], 
    ...
    def calculate_eval_stats(self, results: List[Dict[str, Any]], 
                           players: List[NeuralPlayer]) -> Dict[str, Any]:
        """Calculate evaluation statistics"""
        wins = [0] * 4
        total_scores = [0] * 4
